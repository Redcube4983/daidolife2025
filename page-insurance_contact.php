<?php
/*
Template Name: page-insurance_contact
*/
?>
<?php get_header(); ?>
<main>
<div class="p-fv">
	<div class="p-fv__text-area-title">
		<h1 class="p-fv__page-title"><?php the_title(); ?><span class="p-fv__page-title__en"><?php if (is_page('insurance_contact')) : ?>Insurance inquiries<?php elseif (is_page('insurance_error')) : ?>Insurance inquiries error<?php elseif (is_page('insurance_confilm')) : ?>Insurance inquiries Confilm<?php elseif (is_page('insurance_completion')) : ?>Insurance inquiries completion<?php endif; ?></span></h1>
	</div>
	<picture>
 ...
 <nav aria-label="breadcrumb">
        <ol class="c-breadcrumb">
            ...
            <li><span class="c-breadcrumb__separator" aria-current="page">＞</span><a href="/insurance/" class="c-breadcrumb__link">保険</a></li>
            <?php if (is_page('insurance_contact')) : ?>
            <li><span class="c-breadcrumb__separator" aria-current="page">＞</span>保険のお問い合わせ</li>
            <?php elseif (is_page(array('insurance_confilm','insurance_completion','insurance_error'))) : ?>
            <li><span class="c-breadcrumb__separator" aria-current="page">＞</span><a href="/insurance_contact/" class="c-breadcrumb__link">保険のお問い合わせ</a></li>
...
<div id="contents" class="contents">
    <section class="p-contact">
        <?php if (is_page('insurance_contact')) : ?>
        <p class="p-contact__explanation">保険に関する総合お問い合わせは、<br class="sp">下記フォームをご利用ください。<br>以下の必須項目をご入力のうえ、<br class="sp">【入力内容確認画面へ】ボタンを押してください。<br>確認画面に進みますので、内容をご確認後<br class="sp">【送信】ボタンをクリックしてください。</p>
        <?php elseif (is_page('insurance_error')) : ?>
        ...
        <?php elseif (is_page('insurance_confilm')) : ?>
        ...
        <div class="p-contactPage__progress">
            <div class="p-formIndicator">
                ...
                <?php elseif (is_page('insurance_confilm')) : ?>
                    ...
                    <li class="p-formIndicator__item p-formIndicator__item--complete">完了</li>
                <?php elseif (is_page('insurance_completion')) : ?>
                    <li class="p-formIndicator__item p-formIndicator__item--input">入力</li>
                    <li class="p-formIndicator__item p-formIndicator__item--error">エラー</li>
                    <li class="p-formIndicator__item p-formIndicator__item--confirm">確認</li>
        ...
        <?php echo do_shortcode('[mwform_formkey key="140"]'); ?>
    </section>
    <?php get_contact(); ?>
</div>
</main>
